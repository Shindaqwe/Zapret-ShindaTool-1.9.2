@echo off
set "LOCAL_VERSION=SHINDAQWE TELEGRAM"
...
echo 3. Check Status
echo 4. Run Diagnostics _ Use for fix
...
echo 11. Run Tests
echo 12. ________________________________________SHINDAQWE TELEGRAM SUB PLZ___________________________________
echo 0. Exit
